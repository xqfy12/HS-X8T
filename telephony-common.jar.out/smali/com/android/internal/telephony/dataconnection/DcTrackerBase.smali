...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 652
    invoke-virtual {v2}, Lcom/android/internal/telephony/dataconnection/DcAsyncChannel;->disconnected()V
    ...
    const-string v9, "CMD_SET_ENABLE_FAIL_FAST_MOBILE_DATA: enabled="
    ...
    .line 759
    iget-boolean v8, p0, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->mFailFast:Z

    if-eq v8, v3, :cond_0

    .line 760
    iput-boolean v3, p0, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->mFailFast:Z

    .line 761
    if-nez v3, :cond_9

    :goto_7
    iput-boolean v7, p0, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->mDataStallDetectionEnabled:Z
    ...
    .line 767
    :cond_7
    const-string v7, "CMD_SET_ENABLE_FAIL_FAST_MOBILE_DATA: start data stall"
    ...
    .line 771
    :cond_a
    const-string v7, "CMD_SET_ENABLE_FAIL_FAST_MOBILE_DATA: stop data stall"
...
.method protected onSetUserDataEnabled(Z)V
    ...
    const-string v5, "onSetUserDataEnabled  "
    ...
    const-string v2, "android.net.conn.SET_MOBILE_DATA"
    ...
    .line 1164
    const-string v2, "onSetUserDataEnabled send ACTION_SET_MOBILE_DATA"
...
.method protected startDataStallAlarm(Z)V
    ...
    const-string v3, "persist.radio.datastall.enabled"
    ...
    invoke-virtual {p0, v1, v3, v4}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method protected stopDataStallAlarm()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->removeMessages(I)V
