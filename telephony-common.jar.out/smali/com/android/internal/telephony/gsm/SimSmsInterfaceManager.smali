...
# virtual methods
.method public copyMessageToIccEfWithIndex(I[B[B)I
    .locals 6
    .parameter "status"
    .parameter "pdu"
    .parameter "smsc"
    ...
    :try_start_0
    iput v2, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mWriteIndex:I
    ...
    .line 247
    iget v2, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mWriteIndex:I
...
.method public getSmsCapCountOnIcc()I
    ...
    const-string v3, "getSmsCapCountOnIcc - aborting, no icc card present."
    ...
    .line 291
    :cond_0
    invoke-virtual {v0}, Lcom/android/internal/telephony/uicc/IccFileHandler;->getSmsCapCountOnIcc()I
    ...
    const-string v4, "getSmsCapCountOnIcc().numberOnIcc="
...
.method public setSimSmsRead(IZ)Z
    ...
    const-string v3, "315 setUimSmsRead()"
    ...
    invoke-interface {v2, p1, v1}, Lcom/android/internal/telephony/CommandsInterface;->setSimSmsRead(ILandroid/os/Message;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setSmsPreStore(I)Z
    ...
    const-string v2, "z263 setSmsPreStore preStore = "
    ...
    invoke-interface {v0, p1, v1}, Lcom/android/internal/telephony/CommandsInterface;->setSmsPreStore(ILandroid/os/Message;)V
