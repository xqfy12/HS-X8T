...
#-----------------------------------------------------------------------------
#vendor_saved_apps := Bluetooth FMRadio Stk
...
#-----------------------------------------------------------------------------
vendor_modify_jars := android.policy framework hs-framework pm services telephony-common
...
#-----------------------------------------------------------------------------
baidu_remove_apps := iReader GameCenter BaiduMap BaiduGallery3D BaiduAppSearch BaiduBrowser SearchBox
