...
.field public static final MEDIA_INTERNAL:Ljava/lang/String; = "internal"
...
.field public static final MEDIA_SD:Ljava/lang/String; = "sd"
...
.field private static final STORAGE_SDCARD0_DIRECTORY_FILE:Ljava/io/File; = null

.field private static final STORAGE_SDCARD0_DIRECTORY_PATH:Ljava/lang/String; = "/storage/sdcard0"

.field private static final STORAGE_SDCARD1_DIRECTORY_FILE:Ljava/io/File; = null

.field private static final STORAGE_SDCARD1_DIRECTORY_PATH:Ljava/lang/String; = "/storage/sdcard1"

.field private static final SYSTEM_PROPERTY_EFS_ENABLED:Ljava/lang/String; = "persist.security.efs.enabled"

.field private static final SYSTEM_PROPERTY_PRIMARY_STORAGE:Ljava/lang/String; = "persist.sys.hmct.primary.st"

.field private static final SYSTEM_PROPERTY_SDCARD_CHANGE:Ljava/lang/String; = "ro.hmct.sdcard.change"
...
.method static constructor <clinit>()V
    ...
    .line 773
    const-string v0, "PHONE_STORAGE_DIR"
    ...
    sput-object v0, Landroid/os/Environment;->STORAGE_SDCARD0_DIRECTORY_FILE:Ljava/io/File;

    .line 775
    const-string v0, "EXTERNAL_SD_STORAGE"
    ...
    sput-object v0, Landroid/os/Environment;->STORAGE_SDCARD1_DIRECTORY_FILE:Ljava/io/File;
...
.method public static HmctSdcardChangeOn()Z
    .locals 3

    .prologue
    .line 785
    const-string/jumbo v1, "ro.hmct.sdcard.change"
    ...
    .line 786
    .local v0, HmctSdcardChangeOn:Z
    return v0
.end method

.method public static PrimaryStorageIsInternal()Z
    .locals 4
    ...
    .line 792
    .local v0, PrimaryStorageIsInternal:Z
    return v0
.end method
...
.method public static getCurrentPrimaryStorage()Ljava/lang/String;
    .locals 5

    .prologue
    .line 797
    const-string/jumbo v2, "ro.hmct.sdcard.change"
    ...
    const-string v4, "getExternalStorageSdDirectory change="
...
.method public static getExternalStorageSdDirectory()Ljava/io/File;
    .locals 2
    ...
    const-string v1, "getExternalStorageSdDirectory"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 751
    invoke-static {}, Landroid/os/Environment;->HmctSdcardChangeOn()Z
    ...
    .line 752
    invoke-static {}, Landroid/os/Environment;->PrimaryStorageIsInternal()Z
    ...
    .line 753
    sget-object v0, Landroid/os/Environment;->STORAGE_SDCARD1_DIRECTORY_FILE:Ljava/io/File;
    ...
    .line 755
    :cond_0
    sget-object v0, Landroid/os/Environment;->STORAGE_SDCARD0_DIRECTORY_FILE:Ljava/io/File;
...
.method public static getExternalStorageSdState()Ljava/lang/String;
    .locals 3
...
.method public static isPhoneStorageSupported()Ljava/lang/Boolean;
    .locals 2

    .prologue
    .line 724
    const-string/jumbo v0, "ro.product.phonesupported"
...
.method public static isTFCardSupported()Ljava/lang/Boolean;
    .locals 2

    .prologue
    .line 719
    const-string/jumbo v0, "ro.hmct.TFcard.supported"
