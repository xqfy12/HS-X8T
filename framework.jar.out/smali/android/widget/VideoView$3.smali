...
.method public onPrepared(Landroid/media/MediaPlayer;)V
    ...
    invoke-static {v2, v6}, Landroid/widget/VideoView;->access$402(Landroid/widget/VideoView;I)I
    ...
    invoke-static {v2}, Landroid/widget/VideoView;->access$800(Landroid/widget/VideoView;)Landroid/media/MediaPlayer$OnPreparedListener;
    ...
    invoke-static {v5}, Landroid/widget/VideoView;->access$900(Landroid/widget/VideoView;)Landroid/media/MediaPlayer;
    ...
    invoke-static {v2}, Landroid/widget/VideoView;->access$1000(Landroid/widget/VideoView;)Landroid/widget/MediaController;
    ...
    invoke-static {v2, p1}, Landroid/widget/VideoView;->access$100(Landroid/widget/VideoView;Landroid/media/MediaPlayer;)V
    ...
    #setter for: Landroid/widget/VideoView;->mCanSeekForward:Z
    invoke-static {v6, v4}, Landroid/widget/VideoView;->access$702(Landroid/widget/VideoView;Z)Z

    move-result v6

    #setter for: Landroid/widget/VideoView;->mCanSeekBack:Z
    invoke-static {v5, v6}, Landroid/widget/VideoView;->access$602(Landroid/widget/VideoView;Z)Z

    move-result v5

    #setter for: Landroid/widget/VideoView;->mCanPause:Z
    invoke-static {v2, v5}, Landroid/widget/VideoView;->access$502(Landroid/widget/VideoView;Z)Z
