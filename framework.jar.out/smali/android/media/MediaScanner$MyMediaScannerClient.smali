...
.method private createPlaylist(Landroid/content/ContentResolver;Ljava/lang/String;)Landroid/net/Uri;
    .locals 3
    .parameter "resolver"
...
.method private endFile(Landroid/media/MediaScanner$FileEntry;ZZZZZZZ)Landroid/net/Uri;
    .locals 38
    .parameter "entry"
    .parameter "ringtones"
    ...
    .line 1064
    .local v12, audioId:I
    const-string v26, "My recordings"

    .line 1065
    .local v26, mPlaylist:Ljava/lang/String;
    const/4 v4, 0x1
    ...
    invoke-direct {v0, v11}, Landroid/media/MediaScanner$MyMediaScannerClient;->getPlaylistId([Ljava/lang/String;)I
    ...
    invoke-direct {v0, v1, v4}, Landroid/media/MediaScanner$MyMediaScannerClient;->createPlaylist(Landroid/content/ContentResolver;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-direct {v0, v1, v12, v4, v5}, Landroid/media/MediaScanner$MyMediaScannerClient;->addToPlaylist(Landroid/content/ContentResolver;IJ)V

    .line 1096
    .end local v11           #args:[Ljava/lang/String;
    .end local v12           #audioId:I
    .end local v22           #isRecordAudio:Z
    .end local v23           #lastDot:I
    .end local v26           #mPlaylist:Ljava/lang/String;
    ...
    .restart local v28       #needToSetSettings:Z
    :cond_1d
    if-eqz p2, :cond_1f
    ...
    .line 1057
    .restart local v16       #extension:Ljava/lang/String;
    .restart local v22       #isRecordAudio:Z
    ...
    .line 1081
    .restart local v12       #audioId:I
    const-string v26, "FM recordings"

    .line 1082
    .restart local v26       #mPlaylist:Ljava/lang/String;
    const/4 v4, 0x1
    ...
    .end local v11           #args:[Ljava/lang/String;
    .end local v12           #audioId:I
    .end local v21           #isFmRecordAudio:Z
    .end local v23           #lastDot:I
    .end local v26           #mPlaylist:Ljava/lang/String;
    .end local v31           #resolver:Landroid/content/ContentResolver;
    :cond_25
...
.method private getPlaylistId([Ljava/lang/String;)I
    ...
    invoke-direct/range {v0 .. v5}, Landroid/media/MediaScanner$MyMediaScannerClient;->query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
...
.method public doScanFile(Ljava/lang/String;Ljava/lang/String;JJZZZ)Landroid/net/Uri;
    ...
    invoke-direct/range {v3 .. v11}, Landroid/media/MediaScanner$MyMediaScannerClient;->endFile(Landroid/media/MediaScanner$FileEntry;ZZZZZZZ)Landroid/net/Uri;
    ...
    #getter for: Landroid/media/MediaScanner;->mExternalStoragePath:Ljava/lang/String;
    invoke-static/range {v20 .. v20}, Landroid/media/MediaScanner;->access$700(Landroid/media/MediaScanner;)Ljava/lang/String;
    ...
    .end local v10           #record:Z
    .end local v11           #fmrecord:Z
    ...
    const-string v20, "RemoteException in MediaScanner.scanFile()"

    move-object/from16 v0, v20

    invoke-static {v3, v0, v13}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
