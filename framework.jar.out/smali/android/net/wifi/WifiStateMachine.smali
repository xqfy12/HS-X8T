...
.field private static final ACTION_SET_WIFI_LOG_LEVEL:Ljava/lang/String; = "com.android.LogMaster.setLogLev"
...
.field private static final DATA_WIFI_CONNECT_TYPE_AUTO:I = 0x0
...
.field private static final MIN_INTERVAL_ENABLE_ALL_NETWORKS_MS:I = 0x2bf20
...
.field private static final WIFI_MODE_AP:I = 0x1

.field private static final WIFI_MODE_P2P_STA:I = 0x2

.field private static final WIFI_MODE_STA:I
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v6}, Landroid/net/wifi/p2p/WifiP2pDeviceList;-><init>()V

    iput-object v6, p0, Landroid/net/wifi/WifiStateMachine;->mPeers:Landroid/net/wifi/p2p/WifiP2pDeviceList;
    ...
    const-string v11, "com.android.LogMaster.setLogLev"
    ...
    invoke-virtual {p0, v6, v9}, Landroid/net/wifi/WifiStateMachine;->addState(Lcom/android/internal/util/State;Lcom/android/internal/util/State;)V
...
.method static synthetic access$000(Landroid/net/wifi/WifiStateMachine;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1000(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WifiNative;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$10500(Landroid/net/wifi/WifiStateMachine;)Landroid/os/PowerManager$WakeLock;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$10908(Landroid/net/wifi/WifiStateMachine;)I
    .locals 2
    .parameter "x0"
...
.method static synthetic access$1402(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/AsyncChannel;)Lcom/android/internal/util/AsyncChannel;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$14302(Landroid/net/wifi/WifiStateMachine;Ljava/util/List;)Ljava/util/List;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$14500(Landroid/net/wifi/WifiStateMachine;)Landroid/os/Message;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$16000(Landroid/net/wifi/WifiStateMachine;)J
    .locals 2
    .parameter "x0"
...
.method static synthetic access$16002(Landroid/net/wifi/WifiStateMachine;J)J
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$16100(Landroid/net/wifi/WifiStateMachine;Landroid/net/wifi/WifiConfiguration;)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 105
    invoke-direct {p0, p1}, Landroid/net/wifi/WifiStateMachine;->checkSsidConverted(Landroid/net/wifi/WifiConfiguration;)Z
...
.method static synthetic access$17808(Landroid/net/wifi/WifiStateMachine;)I
    .locals 2
    .parameter "x0"
...
.method static synthetic access$1800(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;II)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$18000(Landroid/net/wifi/WifiStateMachine;Landroid/net/DhcpResults;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1900(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;ILjava/lang/Object;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$19500(Landroid/net/wifi/WifiStateMachine;Landroid/net/wifi/RssiPacketCountInfo;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$21700(Landroid/net/wifi/WifiStateMachine;)Landroid/net/ConnectivityManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2200(Landroid/net/wifi/WifiStateMachine;IZ)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$2300(Landroid/net/wifi/WifiStateMachine;)Ljava/lang/String;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$23700(Landroid/net/wifi/WifiStateMachine;)Landroid/os/Message;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$23800(Landroid/net/wifi/WifiStateMachine;Landroid/net/wifi/WifiConfiguration;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$23900(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2400(Landroid/net/wifi/WifiStateMachine;ILjava/lang/Object;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$24900(Landroid/net/wifi/WifiStateMachine;)V
    ...
    .prologue
    .line 105
    invoke-direct {p0}, Landroid/net/wifi/WifiStateMachine;->stopSoftAp()V
...
.method static synthetic access$25600(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/p2p/WifiP2pDeviceList;
    .locals 1
    .parameter "x0"

    .prologue
    .line 105
    iget-object v0, p0, Landroid/net/wifi/WifiStateMachine;->mPeers:Landroid/net/wifi/p2p/WifiP2pDeviceList;

    return-object v0
.end method

.method static synthetic access$25700(Landroid/net/wifi/WifiStateMachine;)V
    .locals 0
    .parameter "x0"

    .prologue
    .line 105
    invoke-direct {p0}, Landroid/net/wifi/WifiStateMachine;->sendWifiApClientChangedBroadcast()V
...
.method static synthetic access$25900(Landroid/net/wifi/WifiStateMachine;)I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$25904(Landroid/net/wifi/WifiStateMachine;)I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$26400(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$26500(Landroid/net/wifi/WifiStateMachine;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$26600(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$26900(Landroid/net/wifi/WifiStateMachine;)V
    .locals 0
    .parameter "x0"
...
.method static synthetic access$27000(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/State;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$300(Landroid/net/wifi/WifiStateMachine;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3000(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/p2p/WifiP2pManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$5704(Landroid/net/wifi/WifiStateMachine;)I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$5902(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$6200(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WifiInfo;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$6300(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WifiConfigStore;
    .locals 1
    .parameter "x0"
...
.method private checkSsidConverted(Landroid/net/wifi/WifiConfiguration;)Z
    .locals 8
    .parameter "config"
    ...
    invoke-virtual {p0}, Landroid/net/wifi/WifiStateMachine;->syncGetScanResultsList()Ljava/util/List;
    ...
    iget-object v6, v2, Landroid/net/wifi/ScanResult;->wifiSsid:Landroid/net/wifi/WifiSsid;

    iget-boolean v6, v6, Landroid/net/wifi/WifiSsid;->NOT_UTF8:Z
    ...
    const-string/jumbo v6, "target converted SSID found:"
...
.method private handleNetworkDisconnect()V
    ...
    invoke-static {v1}, Landroid/net/wifi/WifiManager;->getCmccEnvSettingsAutocon(Landroid/content/Context;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {p0}, Landroid/net/wifi/WifiStateMachine;->shouldAutoConnect()Z
...
.method private handleScreenStateChanged(Z)V
    ...
    const-string v1, "handleScreenStateChanged: "
    ...
    .line 1276
    invoke-virtual {p0, v5, v3, v3}, Landroid/net/wifi/WifiStateMachine;->sendMessage(III)V
    ...
    .line 1280
    invoke-virtual {p0, v5, v4, v3}, Landroid/net/wifi/WifiStateMachine;->sendMessage(III)V
...
.method private sendWifiApClientChangedBroadcast()V
    .locals 3
    ...
    .line 1750
    const-string/jumbo v1, "wifi_ap_client"

    iget-object v2, p0, Landroid/net/wifi/WifiStateMachine;->mPeers:Landroid/net/wifi/p2p/WifiP2pDeviceList;
...
.method private stopSoftAp()V
    ...
    invoke-static {v1}, Landroid/net/wifi/WifiNative;->killSupplicant(I)Z
    ...
    const-string v2, "Failed to stop Soft Ap "
...
.method public declared-synchronized setActiveRoaming(Z)Z
    .locals 2
    .parameter "enabled"
    ...
    invoke-virtual {v0, p1}, Landroid/net/wifi/WifiNative;->setActiveRoamingCommand(Z)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public setWifiLogLev(Landroid/content/Context;Landroid/content/Intent;)V
    .locals 13
    .parameter "context"
    .parameter "intent"
    ...
    .prologue
    .line 812
    const-string/jumbo v1, "wifi_drv_arg"

    .line 813
    .local v1, WIFI_DRV_ARG:Ljava/lang/String;
    const-string v0, "extra_supplicant_arg"

    .line 814
    .local v0, EXTRA_SUPPLICANT_ARG:Ljava/lang/String;
    const-string v9, ""

    .line 817
    .local v9, supplicantArg:Ljava/lang/String;
    const-string/jumbo v11, "wifi_statemachine_db_level"
    ...
    :goto_0
    sput-boolean v11, Landroid/net/wifi/WifiStateMachine;->DBG:Z
    ...
    const-string v12, "Set stateMachine log enable: "
    ...
    invoke-virtual {p0, v11}, Landroid/net/wifi/WifiStateMachine;->setDbg(Z)V

    .line 823
    const-string/jumbo v11, "wifi_hal_db_level"
    ...
    .line 824
    .local v5, mrvlHalExtra:I
    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "Set mrvl WIFI HAL log level: "
    ...
    invoke-virtual {v11, v5}, Landroid/net/wifi/WifiNative;->setWifiHalDbg(I)V

    .line 830
    const-string/jumbo v11, "wpa_db_stamp"
    ...
    .line 833
    :cond_0
    const-string/jumbo v11, "wpa_db_level"
    ...
    .line 834
    .local v6, new_wpa_loglevel:I
    const-string v2, ""

    .line 835
    .local v2, db_level_flag:Ljava/lang/String;
    const/4 v11, 0x3
    ...
    .line 818
    .end local v2           #db_level_flag:Ljava/lang/String;
    .end local v4           #i:I
    .end local v5           #mrvlHalExtra:I
    .end local v6           #new_wpa_loglevel:I
    .end local v7           #new_wpa_stamp:I
    :cond_2
    const/4 v11, 0x0
    ...
    .line 837
    .restart local v2       #db_level_flag:Ljava/lang/String;
    .restart local v5       #mrvlHalExtra:I
    .restart local v6       #new_wpa_loglevel:I
    .restart local v7       #new_wpa_stamp:I
    :cond_3
    const/4 v11, 0x3
    ...
    invoke-virtual {v11, v6, v7}, Landroid/net/wifi/WifiNative;->setSupplicantLogLevel(II)Z
    ...
    const-string v12, "Set wpa_supplicant log level: "
    ...
    .line 855
    .local v3, extraSupplicantArg:Ljava/lang/String;
    ...
    :goto_3
    invoke-virtual {v12, v11}, Landroid/net/wifi/WifiNative;->setSupplicantArg(Ljava/lang/String;)Z
    ...
    const-string v12, "Set supplicant argument: "
    ...
    .end local v9           #supplicantArg:Ljava/lang/String;
    :goto_4
    invoke-virtual {v11, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    .line 861
    .local v10, wifiDrvArg:Ljava/lang/String;
    iget-object v12, p0, Landroid/net/wifi/WifiStateMachine;->mWifiNative:Landroid/net/wifi/WifiNative;
    ...
    :goto_5
    invoke-virtual {v12, v11}, Landroid/net/wifi/WifiNative;->setWifiDrvArg(Ljava/lang/String;)Z
    ...
    const-string v12, "Set WiFi driver argument: "
    ...
    .end local v10           #wifiDrvArg:Ljava/lang/String;
    :cond_7
    ...
    .line 855
    .restart local v9       #supplicantArg:Ljava/lang/String;
    :cond_9
    new-instance v11, Ljava/lang/StringBuilder;
    ...
    .end local v9           #supplicantArg:Ljava/lang/String;
    .restart local v10       #wifiDrvArg:Ljava/lang/String;
    :cond_b
    move-object v11, v10
...
.method shouldAutoConnect()Z
    ...
    const-string v6, "data_wifi_connect_type"
    ...
    const-string v5, "Should auto connect"
    ...
    .end local v2           #dataToWiFiPolicy:I
    :cond_1
    const-string v5, "WifiStateMachine"
    ...
    const-string v7, "Active network type:"
    ...
    .line 4038
    .restart local v0       #autoConnectPolicy:I
    .restart local v2       #dataToWiFiPolicy:I
    :cond_2
    const-string v5, "WifiStateMachine"

    const-string v6, "Shouldn\'t auto connect"
