...
.field public static final RTC_AUTO_POWERON_WAKEUP:I = 0x7
...
.method public cancelAlarm(ILandroid/app/PendingIntent;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/app/IAlarmManager;->cancelAlarm(ILandroid/app/PendingIntent;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getAlarmExtInterfaceVersion()I
    ...
    invoke-interface {v0}, Landroid/app/IAlarmManager;->getAlarmExtInterfaceVersion()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getPowerOnReason()I
    ...
    invoke-interface {v1}, Landroid/app/IAlarmManager;->getPowerOnReason()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
