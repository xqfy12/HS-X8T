...
.method private checkPermissionForCall([Landroid/content/Intent;)Z
    ...
    .line 2075
    .restart local v0       #arr$:[Landroid/content/Intent;
    .restart local v1       #callIntent:Landroid/content/Intent;
    .restart local v3       #i$:I
    .restart local v4       #intent:Landroid/content/Intent;
    .restart local v5       #isCallAction:Z
    ...
    .end local v4           #intent:Landroid/content/Intent;
    :cond_3
    const-string/jumbo v9, "mobile_safe"

    invoke-static {v9}, Landroid/os/ServiceManager;->getService(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v9

    invoke-static {v9}, Landroid/safe/IMobileSafe$Stub;->asInterface(Landroid/os/IBinder;)Landroid/safe/IMobileSafe;

    move-result-object v7

    .line 2089
    .local v7, mobileSafe:Landroid/safe/IMobileSafe;
    if-eqz v7, :cond_1
    ...
    const-string/jumbo v9, "ms_extra_type"
    ...
    .line 2092
    const-string/jumbo v9, "ms_extra_call_number"
    ...
    invoke-interface {v7, v9, v10, v2}, Landroid/safe/IMobileSafe;->checkUidPermissionEx(Ljava/lang/String;ILandroid/os/Bundle;)I
    :try_end_0
