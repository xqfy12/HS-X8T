...
.field private static final LONGPRESS_VOLUME_KEY_INTERVAL:I = 0xc8
...
.field private mVolumeDownWithScreenOff:Z

.field private final mVolumeUpDownRunnable:Ljava/lang/Runnable;

.field private mVolumeUpKeyTriggered:Z

.field private mVolumeUpWithScreenOff:Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeUpDownRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$200(Lcom/android/internal/policy/impl/PhoneWindowManager;)I
    ...
    .prologue
    .line 120
    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->getStreamActive()I
...
.method static synthetic access$300(Lcom/android/internal/policy/impl/PhoneWindowManager;)Z
    ...
    .prologue
    .line 120
    iget-boolean v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeUpWithScreenOff:Z
...
.method static synthetic access$400(Lcom/android/internal/policy/impl/PhoneWindowManager;)Z
    ...
    .prologue
    .line 120
    iget-boolean v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeDownWithScreenOff:Z
...
.method private cancelVolumeUpDownRunnable()V
    .locals 2
    ...
    .line 711
    iput-boolean v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeUpWithScreenOff:Z

    .line 712
    iput-boolean v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeDownWithScreenOff:Z

    .line 713
    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHandler:Landroid/os/Handler;

    iget-object v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeUpDownRunnable:Ljava/lang/Runnable;
...
.method private getStreamActive()I
    .locals 2
    ...
    .line 700
    .local v0, stream:I
    invoke-virtual {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->isVoiceActive()Z
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    .prologue
    const/high16 v6, #android:id@background#h0
...
##
    ...
    iget-object v3, v12, Landroid/view/WindowManager$LayoutParams;->packageName:Ljava/lang/String;

    if-eqz v3, :cond_b

    iget-object v3, v12, Landroid/view/WindowManager$LayoutParams;->packageName:Ljava/lang/String;

    const-string v5, "com.android.engtest"
    ...
    const-string v5, "com.android.charger"
    ...
    .line 2174
    .local v30, shortcutIntent:Landroid/content/Intent;
    if-eqz v30, :cond_25
    ...
    .line 2188
    .end local v30           #shortcutIntent:Landroid/content/Intent;
    :cond_24
    :goto_7
    const-wide/16 v5, -0x1
    ...
    .line 2178
    .restart local v30       #shortcutIntent:Landroid/content/Intent;
    :catch_1
    move-exception v18
    ...
    .line 2235
    .local v29, shiftlessModifiers:I
    const/4 v3, 0x2
    ...
    .line 2243
    .end local v29           #shiftlessModifiers:I
    :cond_2a
    if-nez v17, :cond_2b
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    .line 3743
    .local v6, engModeFlag:Z
    const-string v17, "2"

    const-string v18, "ro.factorytest"
    ...
    .end local v5           #down:Z
    .end local v6           #engModeFlag:Z
    .end local v9           #isChargeMode:Z
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isShowingAndNotHidden()Z
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isShowing()Z
    ...
    .line 3743
    .restart local v6       #engModeFlag:Z
    ...
    .line 3755
    .restart local v9       #isChargeMode:Z
    :cond_c
    const/4 v11, 0x0
    ...
    invoke-virtual {v0, v12}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->onWakeKeyWhenKeyguardShowingTq(I)V
    ...
    .line 3820
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->cancelVolumeUpDownRunnable()V
    ...
    iput-boolean v0, v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeDownWithScreenOff:Z
    ...
    iget-object v0, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeUpDownRunnable:Ljava/lang/Runnable;
    ...
    iput-boolean v0, v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeUpWithScreenOff:Z
    ...
    const-string v19, "powerkey return result = "
...
.method isVoiceActive()Z
    ...
    const-string v2, "isVoiceActive: couldn\'t get AudioManager reference"
    ...
    :cond_0
    invoke-virtual {v0}, Landroid/media/AudioManager;->isVoiceActive()Z
