...
.method private onDropToDelete()V
    ...
    .line 2499
    iget-object v4, p0, Lcom/android/internal/policy/impl/keyguard/PagedView;->mDragView:Landroid/view/View;

    .line 2501
    .local v4, dragView:Landroid/view/View;
    ...
    .line 2511
    .local v5, motionAnim:Landroid/animation/AnimatorSet;
    ...
    .line 2523
    invoke-direct {p0, v4}, Lcom/android/internal/policy/impl/keyguard/PagedView;->createPostDeleteAnimationRunnable(Landroid/view/View;)Ljava/lang/Runnable;

    move-result-object v6

    .line 2525
    .local v6, onAnimationEndRunnable:Ljava/lang/Runnable;
    ...
    .line 2527
    iget v9, p0, Lcom/android/internal/policy/impl/keyguard/PagedView;->DRAG_TO_DELETE_FADE_OUT_DURATION:I
    ...
    .line 2528
    new-instance v9, Lcom/android/internal/policy/impl/keyguard/PagedView$12;

    invoke-direct {v9, p0, v6}, Lcom/android/internal/policy/impl/keyguard/PagedView$12;-><init>(Lcom/android/internal/policy/impl/keyguard/PagedView;Ljava/lang/Runnable;)V
...
.method public onFlingToDelete(Landroid/graphics/PointF;)V
    ...
    new-instance v10, Lcom/android/internal/policy/impl/keyguard/PagedView$10;

    invoke-direct {v10, p0, v4, v5}, Lcom/android/internal/policy/impl/keyguard/PagedView$10;-><init>(Lcom/android/internal/policy/impl/keyguard/PagedView;J)V

    .line 2451
    .local v10, tInterpolator:Landroid/animation/TimeInterpolator;
    ...
    invoke-direct {v2, p0, v9}, Lcom/android/internal/policy/impl/keyguard/PagedView$11;-><init>(Lcom/android/internal/policy/impl/keyguard/PagedView;Ljava/lang/Runnable;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1350
    .end local v17           #leftEdgeBoundary:I
    .end local v19           #p:[F
    .end local v28           #rightEdgeBoundary:I
    :pswitch_2
    move-object/from16 v0, p0
    ...
    check-cast v32, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;

    invoke-virtual/range {v32 .. v32}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;->getContentAppWidgetId()I
    ...
    invoke-virtual {v0, v9, v14}, Lcom/android/internal/policy/impl/keyguard/PagedView;->setPageHoveringOverDeleteDropTarget(IZ)V
    ...
    .line 1425
    .local v21, pageUnderPointIndex:I
    const/16 v32, -0x1
    ...
    .line 1433
    new-instance v32, Lcom/android/internal/policy/impl/keyguard/PagedView$1;
    ...
    invoke-direct {v0, v1, v2, v9}, Lcom/android/internal/policy/impl/keyguard/PagedView$1;-><init>(Lcom/android/internal/policy/impl/keyguard/PagedView;II)V
    ...
    .line 1420
    .end local v21           #pageUnderPointIndex:I
    :cond_a
    move/from16 v0, v27
    ...
    .line 1490
    .restart local v21       #pageUnderPointIndex:I
    :cond_b
    move-object/from16 v0, p0
    ...
    .end local v20           #pageIndexToSnapTo:I
    .end local v21           #pageUnderPointIndex:I
    .end local v23           #parentX:F
    .end local v25           #pt:[F
    .end local v27           #rightBufferEdge:I
    :cond_c
    ...
    .line 1520
    .local v26, returnToOriginalPage:Z
    invoke-static {v8}, Ljava/lang/Math;->abs(I)I
    ...
    iget v10, v0, Lcom/android/internal/policy/impl/keyguard/PagedView;->mCurrentPage:I
    ...
    invoke-virtual {v0, v10, v1}, Lcom/android/internal/policy/impl/keyguard/PagedView;->snapToPageWithVelocity(II)V
    ...
    .end local v22           #pageWidth:I
    .end local v24           #pointerIndex:I
    .end local v26           #returnToOriginalPage:Z
    .end local v29           #velocityTracker:Landroid/view/VelocityTracker;
    .end local v30           #velocityX:I
    .end local v31           #x:F
    :cond_10
    :goto_7
    move-object/from16 v0, p0
    ...
    .restart local v22       #pageWidth:I
    .restart local v24       #pointerIndex:I
    .restart local v29       #velocityTracker:Landroid/view/VelocityTracker;
    .restart local v30       #velocityX:I
    .restart local v31       #x:F
    :cond_11
    const/4 v15, 0x0
    ...
    .restart local v26       #returnToOriginalPage:Z
    :cond_13
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v11}, Lcom/android/internal/policy/impl/keyguard/PagedView;->onFlingToDelete(Landroid/graphics/PointF;)V
