...
.field static final NON_SPECIFIC_LANGUAGE_NOTIFICATION:I = 0x0

.field static final REFRESH_APPLICATION_RESET:I = 0x5
...
.field static final REFRESH_SESSION_RESET:I = 0x6

.field static final REFRESH_UICC_RESET:I = 0x4

.field static final SPECIFIC_LANGUAGE_NOTIFICATION:I = 0x1
...
.method private checkCmdTerminalProfileValue(Lcom/android/internal/telephony/cat/AppInterface$CommandType;)Z
    .locals 5
    .parameter "cmdType"
    ...
    .line 198
    :cond_0
    sget-object v2, Lcom/android/internal/telephony/cat/CommandParamsFactory$1;->$SwitchMap$com$android$internal$telephony$cat$AppInterface$CommandType:[I
    ...
    .line 231
    :pswitch_e
    invoke-direct {p0, v4, v1}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->checkTerminalProfileValue(IB)Z
    ...
    invoke-direct {p0, v4, v0}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->checkTerminalProfileValue(IB)Z
...
.method private checkEventTerminalProfileValue(I)Z
    .locals 7
    .parameter "event"
    ...
    .line 162
    sget-object v1, Lcom/android/internal/telephony/cat/CommandParamsFactory$1;->$SwitchMap$com$android$internal$telephony$cat$EventList:[I
    ...
    invoke-direct {p0, v3, v0}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->checkTerminalProfileValue(IB)Z
    ...
    .line 169
    :pswitch_2
    invoke-direct {p0, v3, v6}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->checkTerminalProfileValue(IB)Z
    ...
    .line 177
    :pswitch_6
    invoke-direct {p0, v3, v5}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->checkTerminalProfileValue(IB)Z
    ...
    .line 181
    :pswitch_8
    invoke-direct {p0, v4, v5}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->checkTerminalProfileValue(IB)Z
    ...
    .line 183
    :pswitch_9
    invoke-direct {p0, v4, v6}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->checkTerminalProfileValue(IB)Z
...
.method private checkTerminalProfileValue(IB)Z
    .locals 8
    .parameter "checkbyte"
    .parameter "value"
    ...
    invoke-static {}, Lcom/android/internal/telephony/cat/CatService;->getUiccApplication()Lcom/android/internal/telephony/uicc/UiccCardApplication;
    ...
    .line 126
    const-string v6, "ril.stk.usim.profile"
    ...
    .line 128
    const-string v6, "ril.stk.sim.profile"
    ...
    const-string v7, "checkTerminalProfileValue "
    ...
    invoke-static {p2, v5}, Ljava/lang/Byte;->toHexString(BZ)Ljava/lang/String;
    ...
    .line 138
    const-string v5, "checkbyte is outof supported"
    ...
    invoke-static {v7, v5}, Ljava/lang/Byte;->toHexString(BZ)Ljava/lang/String;
    ...
    const-string v7, "compare result "
    ...
    .line 149
    :cond_4
    const-string v5, "please check Terminal Profile"
...
.method private processDisplayText(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 627
    const-string v3, "Text Attribute pararmeter"

    invoke-static {p0, v3}, Lcom/android/internal/telephony/cat/CatLog;->d(Ljava/lang/Object;Ljava/lang/String;)V

    .line 628
    invoke-static {v0}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveTextAttribute(Lcom/android/internal/telephony/cat/ComprehensionTlv;)Lcom/android/internal/telephony/cat/TextAttribute;

    move-result-object v3

    iput-object v3, v2, Lcom/android/internal/telephony/cat/TextMessage;->textAttr:Lcom/android/internal/telephony/cat/TextAttribute;
    ...
    .line 635
    sget-boolean v3, Lcom/android/internal/telephony/cat/AppInterface;->STK_ICON_DISABLED:Z
    ...
    .line 636
    iput-boolean v4, v2, Lcom/android/internal/telephony/cat/TextMessage;->disableIcon:Z
...
.method private processEventNotify(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 1045
    :cond_1
    sget-boolean v5, Lcom/android/internal/telephony/cat/AppInterface;->STK_ICON_DISABLED:Z
    ...
    .line 1046
    iput-boolean v3, v2, Lcom/android/internal/telephony/cat/TextMessage;->disableIcon:Z
...
.method private processGetInkey(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 746
    iput-boolean v4, v2, Lcom/android/internal/telephony/cat/Input;->disableIcon:Z
...
.method private processGetInput(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 825
    :cond_2
    sget-boolean v6, Lcom/android/internal/telephony/cat/AppInterface;->STK_ICON_DISABLED:Z
    ...
    .line 826
    iput-boolean v7, v3, Lcom/android/internal/telephony/cat/Input;->disableIcon:Z
...
.method private processLanguageNotification(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 1385
    .local p2, ctlvs:Ljava/util/List;,"Ljava/util/List<Lcom/android/internal/telephony/cat/ComprehensionTlv;>;"
    const-string v1, "process processLanguageNotification"
    ...
    .line 1389
    :pswitch_0
    new-instance v1, Lcom/android/internal/telephony/cat/CommandParams;

    invoke-direct {v1, p1}, Lcom/android/internal/telephony/cat/CommandParams;-><init>(Lcom/android/internal/telephony/cat/CommandDetails;)V
...
.method private processLaunchBrowser(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    :goto_1
    sget-boolean v10, Lcom/android/internal/telephony/cat/AppInterface;->STK_ICON_DISABLED:Z
    ...
    .line 1193
    iput-boolean v9, v0, Lcom/android/internal/telephony/cat/TextMessage;->disableIcon:Z
...
.method private processOpenChannel(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 1520
    const-string v2, "Text Attribute pararmeter"
    ...
    .line 1522
    invoke-static {v13}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveTextAttribute(Lcom/android/internal/telephony/cat/ComprehensionTlv;)Lcom/android/internal/telephony/cat/TextAttribute;

    move-result-object v2

    iput-object v2, v4, Lcom/android/internal/telephony/cat/TextMessage;->textAttr:Lcom/android/internal/telephony/cat/TextAttribute;
    ...
    :cond_8
    const-string v2, "text is null, can\'t set text attribute"
...
.method private processPlayTone(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 1264
    sget-boolean v0, Lcom/android/internal/telephony/cat/AppInterface;->STK_ICON_DISABLED:Z
    ...
    iput-boolean v0, v2, Lcom/android/internal/telephony/cat/TextMessage;->disableIcon:Z
...
.method private processRefresh(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 851
    const-string v3, "process Refresh"
    ...
    const-string v4, "refresh commandQualifier waiting extend"
    ...
    .line 861
    :pswitch_0
    sget-object v3, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->FILE_LIST:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
    ...
    .line 864
    :try_start_0
    invoke-static {v0}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveFileList(Lcom/android/internal/telephony/cat/ComprehensionTlv;)[I

    move-result-object v2

    .line 865
    new-instance v3, Lcom/android/internal/telephony/cat/SetRefreshParams;

    const/4 v4, 0x1

    invoke-direct {v3, p1, v4, v2}, Lcom/android/internal/telephony/cat/SetRefreshParams;-><init>(Lcom/android/internal/telephony/cat/CommandDetails;Z[I)V
    ...
    invoke-direct {v3, p1, v5, v4}, Lcom/android/internal/telephony/cat/SetRefreshParams;-><init>(Lcom/android/internal/telephony/cat/CommandDetails;Z[I)V
...
.method private processSelectItem(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 972
    sget-boolean v7, Lcom/android/internal/telephony/cat/AppInterface;->STK_ICON_DISABLED:Z
    ...
    .line 974
    const-string v7, "titleIconId exist"

    invoke-static {p0, v7}, Lcom/android/internal/telephony/cat/CatLog;->d(Ljava/lang/Object;Ljava/lang/String;)V

    .line 975
    iput-boolean v8, v3, Lcom/android/internal/telephony/cat/Menu;->disableTitleIcon:Z
    ...
    .line 979
    const-string v7, "itemsIconId exist"

    invoke-static {p0, v7}, Lcom/android/internal/telephony/cat/CatLog;->d(Ljava/lang/Object;Ljava/lang/String;)V

    .line 980
    iput-boolean v8, v3, Lcom/android/internal/telephony/cat/Menu;->disableItemsIcon:Z
...
.method private processSetUpEventList(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    const-string v8, "process SetupEventList event = "
    ...
    invoke-direct {p0, v7}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->checkEventTerminalProfileValue(I)Z
    ...
    .line 1095
    const-string v7, "we can support this event,continute"
    ...
    sget-object v8, Lcom/android/internal/telephony/cat/EventList;->REMOVE_EVENT:Lcom/android/internal/telephony/cat/EventList;

    invoke-virtual {v8}, Lcom/android/internal/telephony/cat/EventList;->value()I
    ...
    invoke-direct {v7, p1, v2}, Lcom/android/internal/telephony/cat/SetEventListParams;-><init>(Lcom/android/internal/telephony/cat/CommandDetails;[I)V
...
.method private processSetUpIdleModeText(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 683
    :cond_1
    sget-boolean v4, Lcom/android/internal/telephony/cat/AppInterface;->STK_ICON_DISABLED:Z
...
.method private processSetupCall(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 1327
    iput-boolean v10, v3, Lcom/android/internal/telephony/cat/TextMessage;->disableIcon:Z
    ...
    .line 1331
    iput-boolean v10, v1, Lcom/android/internal/telephony/cat/TextMessage;->disableIcon:Z
...
.method make(Lcom/android/internal/telephony/cat/BerTlv;)V
    ...
    :pswitch_0
    :try_start_1
    invoke-direct {p0, v2}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->checkCmdTerminalProfileValue(Lcom/android/internal/telephony/cat/AppInterface$CommandType;)Z
