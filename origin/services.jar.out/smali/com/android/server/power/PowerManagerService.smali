...
# instance fields
.field private hasButtonBacklight:Z
...
.field private final mKeyBacklightCallbacks:Lcom/hmct/common/power/IKeyBackLightCallback;

.field private mKeyBacklightService:Lcom/hmct/common/power/IKeyBackLightAdjust;
...
.method public constructor <init>()V
    ...
    .line 380
    iput-object v2, p0, Lcom/android/server/power/PowerManagerService;->mKeyBacklightService:Lcom/hmct/common/power/IKeyBackLightAdjust;

    .line 381
    iput-boolean v5, p0, Lcom/android/server/power/PowerManagerService;->hasButtonBacklight:Z
    ...
    iput-object v0, p0, Lcom/android/server/power/PowerManagerService;->mKeyBacklightCallbacks:Lcom/hmct/common/power/IKeyBackLightCallback;
...
.method static synthetic access$1200(Lcom/android/server/power/PowerManagerService;)Z
    ...
    .prologue
    .line 78
    iget-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->hasButtonBacklight:Z

    return v0
.end method

.method static synthetic access$1300(Lcom/android/server/power/PowerManagerService;)Lcom/hmct/common/power/IKeyBackLightAdjust;
    .locals 1
    .parameter "x0"

    .prologue
    .line 78
    iget-object v0, p0, Lcom/android/server/power/PowerManagerService;->mKeyBacklightService:Lcom/hmct/common/power/IKeyBackLightAdjust;
...
.method static synthetic access$1500(Lcom/android/server/power/PowerManagerService;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2500(Landroid/os/WorkSource;)Landroid/os/WorkSource;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2600(Lcom/android/server/power/PowerManagerService;Lcom/android/server/power/PowerManagerService$WakeLock;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private updateDisplayPowerStateLocked(I)V
    ...
    iget-boolean v4, p0, Lcom/android/server/power/PowerManagerService;->hasButtonBacklight:Z

    if-eqz v4, :cond_5

    and-int/lit16 v4, p1, 0x4200
    ...
    .line 1697
    iget-object v4, p0, Lcom/android/server/power/PowerManagerService;->mKeyBacklightService:Lcom/hmct/common/power/IKeyBackLightAdjust;
    ...
    invoke-interface {v4, v1, v5, v6}, Lcom/hmct/common/power/IKeyBackLightAdjust;->updateBacklightStateLocked(III)V
...
.method private updatePowerStateLocked()V
    ...
    invoke-interface {v4, v5}, Lcom/hmct/common/power/IKeyBackLightAdjust;->setWakeLockSummary(I)V
    ...
    invoke-interface {v4, v5}, Lcom/hmct/common/power/IKeyBackLightAdjust;->setUserActivitySummary(I)V
...
.method private updateSettingsLocked()V
    ...
    invoke-static {v3, v4, v7, v8}, Landroid/provider/Settings$System;->getFloatForUser(Landroid/content/ContentResolver;Ljava/lang/String;FI)F
    ...
    .restart local v0       #hasBacklight:I
    .restart local v1       #oldScreenAutoBrightnessAdjustmentSetting:F
    .restart local v2       #oldScreenBrightnessSetting:I
    :cond_8
    move v5, v6
...
.method private updateUserActivitySummaryLocked(JI)V
    ...
    .line 1354
    iget-boolean v7, p0, Lcom/android/server/power/PowerManagerService;->hasButtonBacklight:Z

    if-eqz v7, :cond_0

    .line 1355
    iget-object v7, p0, Lcom/android/server/power/PowerManagerService;->mKeyBacklightService:Lcom/hmct/common/power/IKeyBackLightAdjust;
    ...
    invoke-interface {v7, v8, v9}, Lcom/hmct/common/power/IKeyBackLightAdjust;->setCloseBacklightTime(J)V
...
.method public systemReady(Lcom/android/server/TwilightService;Lcom/android/server/dreams/DreamManagerService;)V
    ...
    iget-boolean v2, v0, Lcom/android/server/power/PowerManagerService;->hasButtonBacklight:Z

    if-eqz v2, :cond_0

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/power/PowerManagerService;->mKeyBacklightService:Lcom/hmct/common/power/IKeyBackLightAdjust;

    if-nez v2, :cond_0

    .line 513
    const-class v2, Lcom/hmct/common/power/IKeyBackLightAdjust;
    ...
    iget-object v5, v0, Lcom/android/server/power/PowerManagerService;->mLightsService:Lcom/android/server/LightsService;
    ...
    iget-object v5, v0, Lcom/android/server/power/PowerManagerService;->mKeyBacklightCallbacks:Lcom/hmct/common/power/IKeyBackLightCallback;
    ...
    invoke-static {v2, v3}, Lcom/hmct/common/HmctClassFactory;->createInstance(Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/hmct/common/power/IKeyBackLightAdjust;

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/power/PowerManagerService;->mKeyBacklightService:Lcom/hmct/common/power/IKeyBackLightAdjust;
    ...
    const-string v4, "mKeyBacklightService = "
    ...
    iget-object v4, v0, Lcom/android/server/power/PowerManagerService;->mKeyBacklightService:Lcom/hmct/common/power/IKeyBackLightAdjust;
