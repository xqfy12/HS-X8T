...
.method private checkLocationSecurityPermission(Ljava/lang/String;)I
    .locals 5
    .parameter "provider"
    ...
    .line 2401
    .local v0, mobileSafe:Landroid/safe/IMobileSafe;
    if-eqz v0, :cond_0
    ...
    invoke-interface {v0, v1, v3, v4}, Landroid/safe/IMobileSafe;->checkUidPermissionEx(Ljava/lang/String;ILandroid/os/Bundle;)I
    :try_end_0
    ...
    .line 2392
    .end local v0           #mobileSafe:Landroid/safe/IMobileSafe;
    :cond_3
    ...
    .line 2408
    .restart local v0       #mobileSafe:Landroid/safe/IMobileSafe;
    :catch_0
    move-exception v3
...
.method public addGpsStatusListener(Landroid/location/IGpsStatusListener;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v6}, Lcom/android/server/LocationManagerService;->checkLocationSecurityPermission(Ljava/lang/String;)I
    ...
    const-string v7, "zjh addGpsStatusListener checkMarvellGpsConf"

    invoke-static {v6, v7}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1634
    invoke-virtual {p0}, Lcom/android/server/LocationManagerService;->checkMarvellGpsConf()V
...
.method public checkMarvellGpsConf()V
    .locals 9

    .prologue
    .line 1308
    const-string v6, "ro.hmct.cmcc.test"
    ...
    const-string v7, "zjh File is not existed! recreate it"
    ...
    .line 1319
    .local v2, mGpsProperties:Ljava/util/Properties;
    ...
    invoke-virtual {v2, v6, v7}, Ljava/util/Properties;->setProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;

    .line 1325
    const-string v6, "AIDING_TYPE"
    ...
    .line 1329
    const-string v6, "ROAMING_ALLOWED"
    ...
    const-string v7, "supl.nokia.com"

    invoke-virtual {v2, v6, v7}, Ljava/util/Properties;->setProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;

    .line 1341
    const-string v6, "CER_PATH"

    const-string v7, "/system/etc/AGPS_default.pem"
    ...
    .line 1343
    .local v5, stream1:Ljava/io/FileOutputStream;
    const-string v6, "Generated by Mrvl GPS setting"

    invoke-virtual {v2, v5, v6}, Ljava/util/Properties;->store(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    .end local v2           #mGpsProperties:Ljava/util/Properties;
    .end local v3           #strFilePath:Ljava/lang/String;
    .end local v4           #stream:Ljava/io/FileInputStream;
    .end local v5           #stream1:Ljava/io/FileOutputStream;
    :cond_0
    :goto_0
    return-void
    ...
    const-string v7, "zjh conf File is already existed!"
    ...
    const-string v8, "Fail to save properties:"
...
.method public getLastLocation(Landroid/location/LocationRequest;Ljava/lang/String;)Landroid/location/Location;
    ...
    invoke-direct {p0, v9}, Lcom/android/server/LocationManagerService;->checkLocationSecurityPermission(Ljava/lang/String;)I
...
.method public getProviderProperties(Ljava/lang/String;)Lcom/android/internal/location/ProviderProperties;
    ...
    .line 1723
    invoke-direct {p0, p1}, Lcom/android/server/LocationManagerService;->checkLocationSecurityPermission(Ljava/lang/String;)I
    ...
    const-string v3, "zjh getProviderProperties checkMarvellGpsConf"
...
.method public isProviderEnabled(Ljava/lang/String;)Z
    ...
    const-string v6, "zjh isProviderEnabled checkMarvellGpsConf"
...
.method public requestGeofence(Landroid/location/LocationRequest;Landroid/location/Geofence;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/LocationManagerService;->checkLocationSecurityPermission(Ljava/lang/String;)I
    ...
    const-string v2, "zjh requestGeofence checkMarvellGpsConf"
...
.method public requestLocationUpdates(Landroid/location/LocationRequest;Landroid/location/ILocationListener;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    const-string v1, "zjh requestLocationUpdates checkMarvellGpsConf"
