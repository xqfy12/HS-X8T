...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;Landroid/os/Looper;)V
    ...
    .line 210
    iput-boolean v8, p0, Lcom/android/server/location/GpsLocationProvider;->sAutoTimeGPS:Z
    ...
    iput-wide v9, p0, Lcom/android/server/location/GpsLocationProvider;->mStatusUpdateTime:J
    ...
    iput-object v6, p0, Lcom/android/server/location/GpsLocationProvider;->mContentResolver:Landroid/content/ContentResolver;
    ...
    invoke-virtual {v6, v9}, Landroid/location/Location;->setExtras(Landroid/os/Bundle;)V
    ...
    invoke-static {v6, v8, v9, v8}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    :cond_1
    :goto_1
    iget-object v6, p0, Lcom/android/server/location/GpsLocationProvider;->mContentResolver:Landroid/content/ContentResolver;
    ...
    :goto_2
    iput-boolean v6, p0, Lcom/android/server/location/GpsLocationProvider;->sAutoTimeGPS:Z
    ...
    const-string v9, "Init sAutoTimeGPS= "

    invoke-virtual {v7, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-boolean v9, p0, Lcom/android/server/location/GpsLocationProvider;->sAutoTimeGPS:Z
    ...
    invoke-direct {v9, p0, v10}, Lcom/android/server/location/GpsLocationProvider$3;-><init>(Lcom/android/server/location/GpsLocationProvider;Landroid/os/Handler;)V
    ...
    .line 577
    .end local v0           #autoGpsTimeInitValue:I
    ...
    .end local v3           #portString:Ljava/lang/String;
    .end local v5           #stream:Ljava/io/FileInputStream;
    .restart local v0       #autoGpsTimeInitValue:I
    :cond_2
    move v6, v8
...
.method static synthetic access$600(Lcom/android/server/location/GpsLocationProvider;)Landroid/content/ContentResolver;
    .locals 1
    .parameter "x0"

    .prologue
    .line 103
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mContentResolver:Landroid/content/ContentResolver;
...
.method static synthetic access$700(Lcom/android/server/location/GpsLocationProvider;)Z
    ...
    .prologue
    .line 103
    iget-boolean v0, p0, Lcom/android/server/location/GpsLocationProvider;->sAutoTimeGPS:Z
...
.method static synthetic access$702(Lcom/android/server/location/GpsLocationProvider;Z)Z
    ...
    .prologue
    .line 103
    iput-boolean p1, p0, Lcom/android/server/location/GpsLocationProvider;->sAutoTimeGPS:Z
...
.method private checkWapSuplInit(Landroid/content/Intent;)V
    ...
    .line 447
    .local v9, bValidSupl:I
    const-string v4, "application/vnd.omaloc-supl-init"

    .line 450
    .local v4, CONTENT_MIME_TYPE_B_SUPL_INIT:Ljava/lang/String;
    const/16 v6, 0xaf

    .line 455
    .local v6, PARAMETER_ID_X_WAP_APPLICATION_ID:I
    const/16 v5, 0x90

    .line 456
    .local v5, CONTENT_TYPE_APPLICATION_ID:I
    const-string v3, "x-oma-application:ulp.ua"

    .line 459
    .local v3, CONTENT_MIME_TYPE_APPLICATION_ID:Ljava/lang/String;
    ...
    .line 465
    .local v17, supl_init:[B
    const-string v18, "application/vnd.omaloc-supl-init"
    ...
    const-string v19, "x-oma-application:ulp.ua"
    ...
    const-string v20, "SUPL head length:"
    ...
    const-string v20, "SUPL min string length:"
    ...
    const-string v19, "SUPL number length:6"
    ...
    .line 486
    const-string v18, "x-oma-application:ulp.ua"
    ...
    .line 524
    .end local v7           #app_id:[B
    .end local v12           #j:I
    .end local v14           #parmid:I
    :goto_1
    const/16 v18, 0x1
    ...
    const-string v19, "native_agps_ni_message will be called"
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/location/GpsLocationProvider;->native_agps_ni_message([BI)V
    ...
    .line 488
    .restart local v7       #app_id:[B
    .restart local v12       #j:I
    .restart local v14       #parmid:I
    :cond_2
    ...
    const-string v19, "Wrong SUPL APPLICATION ID"
    ...
    const-string v20, "Wrong Application ID field name ("
    ...
    const-string v20, ") (should be 0xAF)"
    ...
    const-string v20, "Wrong SUPL APPLICATION ID:"
...
.method private reportLocation(IDDDFFFJ)V
    ...
    .line 1282
    iget-boolean v7, p0, Lcom/android/server/location/GpsLocationProvider;->sAutoTimeGPS:Z
    ...
    const-string v9, "reportLocation(): time= ("
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/location/GpsLocationProvider;->setAndBroadcastGPSTime(J)V
    ...
    const-string v8, "PREF_KEY_GPS_TIME_SYNC_VALUE"
    ...
    const-string v9, "Sync system time:"
    ...
    const-string v9, "(ms) with gps time:"
