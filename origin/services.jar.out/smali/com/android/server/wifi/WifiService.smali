...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const-string v4, "android.net.conn.WIFI_VOIP_SWITCH_EVENT"
...
.method static synthetic access$1700(Lcom/android/server/wifi/WifiService;)Ljava/util/List;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1800(Lcom/android/server/wifi/WifiService;II)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$400(Lcom/android/server/wifi/WifiService;)V
    .locals 0
    .parameter "x0"

    .prologue
    .line 91
    invoke-direct {p0}, Lcom/android/server/wifi/WifiService;->grabWifiHighPerfLock()V

    return-void
.end method

.method static synthetic access$500(Lcom/android/server/wifi/WifiService;)V
    .locals 0
    .parameter "x0"

    .prologue
    .line 91
    invoke-direct {p0}, Lcom/android/server/wifi/WifiService;->releaseWifiHighPerfLock()V

    return-void
.end method

.method static synthetic access$600(Lcom/android/server/wifi/WifiService;)Lcom/android/server/wifi/WifiController;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$800(Lcom/android/server/wifi/WifiService;Landroid/os/IBinder;)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method private acquireWifiLockLocked(Lcom/android/server/wifi/WifiService$WifiLock;)Z
    ...
    invoke-static {v3, p1}, Lcom/android/server/wifi/WifiService$LockList;->access$1300(Lcom/android/server/wifi/WifiService$LockList;Lcom/android/server/wifi/WifiService$WifiLock;)V
...
.method private grabWifiHighPerfLock()V
    ...
    .prologue
    .line 231
    iget-object v0, p0, Lcom/android/server/wifi/WifiService;->mWifiHighPerfLock:Landroid/net/wifi/WifiManager$WifiLock;
    ...
    iput-object v0, p0, Lcom/android/server/wifi/WifiService;->mWifiHighPerfLock:Landroid/net/wifi/WifiManager$WifiLock;
...
.method private releaseWifiLockLocked(Landroid/os/IBinder;)Z
    ...
    invoke-static {v4, p1}, Lcom/android/server/wifi/WifiService$LockList;->access$1600(Lcom/android/server/wifi/WifiService$LockList;Landroid/os/IBinder;)Lcom/android/server/wifi/WifiService$WifiLock;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {v3, p2}, Lcom/android/server/wifi/WifiService$LockList;->access$700(Lcom/android/server/wifi/WifiService$LockList;Ljava/io/PrintWriter;)V
...
.method public enableActiveRoaming(Z)Z
    ...
    invoke-virtual {v0, p1}, Landroid/net/wifi/WifiStateMachine;->setActiveRoaming(Z)Z
...
.method public declared-synchronized setWifiEnabled(Z)Z
    ...
    invoke-interface {v2, v4, v5}, Landroid/safe/IMobileSafe;->checkUidPermission(Ljava/lang/String;I)I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
...
.method public updateWifiLockWorkSource(Landroid/os/IBinder;Landroid/os/WorkSource;)V
    ...
    invoke-static {v6, p1}, Lcom/android/server/wifi/WifiService$LockList;->access$1400(Lcom/android/server/wifi/WifiService$LockList;Landroid/os/IBinder;)I
    ...
    invoke-static {v6}, Lcom/android/server/wifi/WifiService$LockList;->access$1500(Lcom/android/server/wifi/WifiService$LockList;)Ljava/util/List;
