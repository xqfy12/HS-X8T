...
.field private static final DEBUG_HMCTCODE:Z = false
...
.field private static mLargeHeapList:Ljava/util/ArrayList;
...
.field private mHmctVersionCode:I

.field private mHmctVersionName:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    new-array v13, v13, [Landroid/content/pm/PackageParser$NewPermissionInfo;

    const/4 v14, 0x0

    new-instance v15, Landroid/content/pm/PackageParser$NewPermissionInfo;
    ...
    invoke-direct/range {v15 .. v18}, Landroid/content/pm/PackageParser$NewPermissionInfo;-><init>(Ljava/lang/String;II)V
    ...
    sput-object v13, Landroid/content/pm/PackageParser;->NEW_PERMISSIONS:[Landroid/content/pm/PackageParser$NewPermissionInfo;

    .line 142
    const/4 v13, 0x3

    new-array v13, v13, [Landroid/content/pm/PackageParser$SplitPermissionInfo;

    const/4 v14, 0x0

    new-instance v15, Landroid/content/pm/PackageParser$SplitPermissionInfo;
    ...
    invoke-direct/range {v15 .. v18}, Landroid/content/pm/PackageParser$SplitPermissionInfo;-><init>(Ljava/lang/String;[Ljava/lang/String;I)V
    ...
    const-string v19, "android.permission.READ_CALL_LOG"
    ...
    const-string v19, "android.permission.WRITE_CALL_LOG"
    ...
    sput-object v13, Landroid/content/pm/PackageParser;->SPLIT_PERMISSIONS:[Landroid/content/pm/PackageParser$SplitPermissionInfo;

    .line 162
    sget v13, Landroid/os/Build$VERSION;->SDK_INT:I

    sput v13, Landroid/content/pm/PackageParser;->SDK_VERSION:I
    ...
    :goto_0
    sput-object v13, Landroid/content/pm/PackageParser;->SDK_CODENAME:Ljava/lang/String;

    .line 168
    new-instance v13, Ljava/lang/Object;

    invoke-direct/range {v13 .. v13}, Ljava/lang/Object;-><init>()V

    sput-object v13, Landroid/content/pm/PackageParser;->mSync:Ljava/lang/Object;

    .line 171
    const/4 v13, 0x1

    sput-boolean v13, Landroid/content/pm/PackageParser;->sCompatibilityModeEnabled:Z
    ...
    invoke-virtual {v5, v13}, Ljavax/xml/parsers/DocumentBuilderFactory;->setValidating(Z)V
    ...
    sput-object v13, Landroid/content/pm/PackageParser;->mLargeHeapList:Ljava/util/ArrayList;

    .line 3975
    new-instance v12, Ljava/io/File;

    const-string v13, "/system/etc/largeheaplist.xml"
    ...
    invoke-direct {v10, v13, v14}, Ljava/io/InputStreamReader;-><init>(Ljava/io/InputStream;Ljava/lang/String;)V
    :try_end_1
    ...
    invoke-direct {v13, v10}, Lorg/xml/sax/InputSource;-><init>(Ljava/io/Reader;)V

    invoke-virtual {v1, v13}, Ljavax/xml/parsers/DocumentBuilder;->parse(Lorg/xml/sax/InputSource;)Lorg/w3c/dom/Document;
    ...
    sget-object v13, Landroid/content/pm/PackageParser;->mLargeHeapList:Ljava/util/ArrayList;
    ...
    const-string v15, "] need large heap founded"
    ...
    .end local v12           #xmlFile:Ljava/io/File;
    :cond_0
    ...
    invoke-direct {v13, v3}, Ljava/lang/Error;-><init>(Ljava/lang/Throwable;)V
    ...
    .restart local v12       #xmlFile:Ljava/io/File;
    :cond_1
...
.method private parseApplication(Landroid/content/pm/PackageParser$Package;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;I[Ljava/lang/String;)Z
    ...
    .line 1901
    :cond_f
    sget-object v3, Landroid/content/pm/PackageParser;->mLargeHeapList:Ljava/util/ArrayList;
    ...
    const-string v6, "Set FLAG_LARGE_HEAP for package : "
    ...
    iget v3, v0, Landroid/content/pm/PackageParser;->mHmctVersionCode:I

    move-object/from16 v0, p1

    iput v3, v0, Landroid/content/pm/PackageParser$Package;->mHmctCode:I

    .line 2040
    move-object/from16 v0, p1

    iget v3, v0, Landroid/content/pm/PackageParser$Package;->mHmctCode:I
    ...
    iput-boolean v3, v0, Landroid/content/pm/PackageParser$Package;->isHmct:Z
...
.method private parseMetaData(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/os/Bundle;[Ljava/lang/String;)Landroid/os/Bundle;
    ...
    iput v4, p0, Landroid/content/pm/PackageParser;->mHmctVersionCode:I
    ...
    invoke-virtual {p4, v1, v5}, Landroid/os/Bundle;->putFloat(Ljava/lang/String;F)V

    .line 3079
    const-string v5, "hmctName"
    ...
    .line 3081
    iput-object v4, p0, Landroid/content/pm/PackageParser;->mHmctVersionName:Ljava/lang/String;
