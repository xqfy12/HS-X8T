...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v2}, Landroid/webkit/WebViewCore;->access$1400(Landroid/webkit/WebViewCore;)Landroid/webkit/BrowserFrame;

    move-result-object v2

    const/4 v5, 0x1

    invoke-virtual {v2, v5}, Landroid/webkit/BrowserFrame;->getCurrentUrlProp(Z)I
    ...
    invoke-virtual {v2}, Landroid/webkit/BrowserFrame;->sendFinishBoostMessageForExtreme()V
    ...
    invoke-static {v2, v5}, Landroid/webkit/WebViewCore;->access$1402(Landroid/webkit/WebViewCore;Landroid/webkit/BrowserFrame;)Landroid/webkit/BrowserFrame;
    ...
    check-cast v33, Landroid/webkit/WebViewCore$BaseUrlData;

    .line 1322
    .local v33, loadParams:Landroid/webkit/WebViewCore$BaseUrlData;
    ...
    .end local v33           #loadParams:Landroid/webkit/WebViewCore$BaseUrlData;
    :pswitch_a
    move-object/from16 v0, p0
    ...
    invoke-virtual {v2, v4}, Landroid/webkit/BrowserFrame;->getCurrentUrlProp(Z)I
    ...
    invoke-virtual {v2}, Landroid/webkit/CallbackProxy;->adjustScreenBrightnessBackForPause()V
    ...
    invoke-virtual {v2}, Landroid/webkit/CallbackProxy;->getScreenBrightnessForResume()V
    ...
    invoke-virtual {v2, v0}, Landroid/webkit/BrowserFrame;->sendBoostMessageForExtreme(I)V

    goto/16 :goto_0

    .line 1432
    .end local v25           #extremeIndex:I
    :pswitch_16
    move-object/from16 v0, p0
    ...
    .line 1451
    .local v34, map:Ljava/util/Map;,"Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;"
    ...
    .line 1456
    .end local v34           #map:Ljava/util/Map;,"Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;"
    :pswitch_19
    move-object/from16 v0, p0
    ...
    #getter for: Landroid/webkit/WebViewCore;->mBrowserFrame:Landroid/webkit/BrowserFrame;
    invoke-static {v4}, Landroid/webkit/WebViewCore;->access$1400(Landroid/webkit/WebViewCore;)Landroid/webkit/BrowserFrame;
    ...
    .line 1742
    .restart local v35       #matchCount:I
    .restart local v36       #matchIndex:I
    :catchall_2
    move-exception v2
