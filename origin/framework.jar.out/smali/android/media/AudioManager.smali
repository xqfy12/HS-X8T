...
.field public static final DEFAULT_STREAM_VOLUME_MAX_RING:[I = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/media/AudioManager;->DEFAULT_STREAM_VOLUME_MAX_RING:[I
...
.method public handleBluetoothScoException(I)V
    ...
    .local v1, service:Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1}, Landroid/media/IAudioService;->handleBluetoothScoException(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in handleBluetoothScoException"
...
.method public setBluetoothScoCapability(Ljava/lang/String;)V
    ...
    .local v1, service:Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1}, Landroid/media/IAudioService;->setBluetoothScoCapability(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in setBluetoothScoCapability"
...
.method public setMode(I)V
    ...
    const-string/jumbo v5, "setMode <MODE_IN_CALL> from non-voice call (caller UID "
    ...
    const-string/jumbo v5, "replace with <MOCE_IN_COMUICATION>"
    ...
    invoke-interface {v1, p1, v3}, Landroid/media/IAudioService;->setMode(ILandroid/os/IBinder;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "Dead object in setMode"
