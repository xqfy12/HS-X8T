...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/ConnectivityService$DialogHandler;,
...
.field private mDialogHandler:Lcom/android/server/ConnectivityService$DialogHandler;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;Lcom/android/server/ConnectivityService$NetworkFactory;)V
    ...
    iput-boolean v2, v0, Lcom/android/server/ConnectivityService;->mAlertShowing:Z
    ...
    iput-boolean v2, v0, Lcom/android/server/ConnectivityService;->firstCheck:Z
    ...
    .line 432
    new-instance v2, Lcom/android/server/ConnectivityService$DialogHandler;
    ...
    invoke-direct {v2, v0, v3}, Lcom/android/server/ConnectivityService$DialogHandler;-><init>(Lcom/android/server/ConnectivityService;Landroid/os/Looper;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/ConnectivityService;->mDialogHandler:Lcom/android/server/ConnectivityService$DialogHandler;
...
.method static synthetic access$1000(Lcom/android/server/ConnectivityService;)Lcom/android/server/ConnectivityService$InternalHandler;
    .locals 1
    .parameter "x0"
...
.method private hasValidCard()Z
    ...
    const-string v4, "hasValidCard hascard="
...
.method public checkMobileProvisioning(ZILandroid/os/ResultReceiver;)I
    ...
    invoke-direct {v0, p0, p3}, Lcom/android/server/ConnectivityService$7;-><init>(Lcom/android/server/ConnectivityService;Landroid/os/ResultReceiver;)V
...
.method public getMobileDataEnabled()Z
    ...
    .line 1625
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->hasValidCard()Z
    ...
    .line 1626
    const-string v2, "getMobileDataEnabled has no card returning false"
    ...
    .local v1, retVal:Z
    :cond_2
    iget-boolean v3, p0, Lcom/android/server/ConnectivityService;->firstCheck:Z
    ...
    const-string v4, "before alert msg when first getMobileDataEnabled"
    ...
    const-string v4, "send alert msg when ro.hmct.cta.test==1"
    ...
    .line 1640
    iget-object v3, p0, Lcom/android/server/ConnectivityService;->mDialogHandler:Lcom/android/server/ConnectivityService$DialogHandler;

    const/16 v4, 0x3e8

    invoke-virtual {v3, v4}, Lcom/android/server/ConnectivityService$DialogHandler;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {v3, v0}, Lcom/android/server/ConnectivityService$DialogHandler;->sendMessage(Landroid/os/Message;)Z

    .line 1642
    const-string v3, "ConnectivityService"

    const-string v4, "sent alert msg for mobile data == 1 and return false to user to deside the connection"

    invoke-static {v3, v4}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1648
    iput-boolean v2, p0, Lcom/android/server/ConnectivityService;->firstCheck:Z
...
.method public isAlertShowing()Z
    .locals 1

    .prologue
    .line 1874
    iget-boolean v0, p0, Lcom/android/server/ConnectivityService;->mAlertShowing:Z
...
.method public setMobileDataEnabled(Z)V
    ...
    .line 1790
    const-string v5, "ms_extra_data_conn_enabled"
    ...
    invoke-interface {v1, v5, v6, v0}, Landroid/safe/IMobileSafe;->checkUidPermissionEx(Ljava/lang/String;ILandroid/os/Bundle;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v1           #mobileSafe:Landroid/safe/IMobileSafe;
    :goto_0
    return-void

    .line 1795
    .restart local v1       #mobileSafe:Landroid/safe/IMobileSafe;
    :catch_0
    move-exception v5
    ...
    .end local v1           #mobileSafe:Landroid/safe/IMobileSafe;
    :cond_0
    const-string v5, "ro.hmct.cta.test"
    ...
    const-string v6, "send alert msg"
    ...
    invoke-virtual {v3, v2}, Lcom/android/server/ConnectivityService$DialogHandler;->sendMessage(Landroid/os/Message;)Z
...
.method public showAlertDialog()V
    ...
    iput-object v1, p0, Lcom/android/server/ConnectivityService;->mDialog:Landroid/app/AlertDialog;
    ...
    invoke-direct {v3, p0}, Lcom/android/server/ConnectivityService$4;-><init>(Lcom/android/server/ConnectivityService;)V
    ...
    iput-boolean v1, p0, Lcom/android/server/ConnectivityService;->mAlertShowing:Z
