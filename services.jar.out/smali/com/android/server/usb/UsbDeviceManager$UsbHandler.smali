...
.method public constructor <init>(Lcom/android/server/usb/UsbDeviceManager;Landroid/os/Looper;)V
    ...
    .line 357
    iput-boolean v6, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mInUsbSetting:Z
    ...
    invoke-static {p1, v8}, Lcom/android/server/usb/UsbDeviceManager;->access$1000(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8, v9}, Lcom/android/server/usb/UsbDeviceManager;->access$1200(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p1}, Lcom/android/server/usb/UsbDeviceManager;->access$1500(Lcom/android/server/usb/UsbDeviceManager;)Landroid/content/BroadcastReceiver;
...
.method static synthetic access$400(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$402(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$500(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$600(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)Z
    .locals 1
    .parameter "x0"

    .prologue
    .line 346
    iget-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mSettingUsbCharging:Z
...
.method static synthetic access$900(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)V
    .locals 0
    .parameter "x0"
...
.method private isStaticFuntion(Ljava/lang/String;)Z
    ...
    const-string v2, "isStaticFuntion functions="
    ...
    const-string v0, "rndis,marvell_modem,marvell_diag,adb"
    ...
    const-string v0, "diag,serial_smd,serial_tty,serial_tty,mass_storage,adb"
    ...
    sget-object v0, Lcom/android/server/usb/UsbDeviceManager;->NO_IMEID_FUNCTION:Ljava/lang/String;
...
.method private setAdbEnabled(Z)V
    ...
    .line 576
    iput-boolean v3, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mSettingUsbCharging:Z
    ...
    invoke-static {v0}, Lcom/android/server/usb/UsbDeviceManager;->access$1600(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbDebuggingManager;
...
.method private setEnabledFunctions(Ljava/lang/String;Z)V
    ...
    .line 592
    const-string v5, "persist.sys.usb.config.extra"
    ...
    const-string v7, "setEnabledFunctions functions="
    ...
    #calls: Lcom/android/server/usb/UsbDeviceManager;->containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
    invoke-static {p1, v5}, Lcom/android/server/usb/UsbDeviceManager;->access$1200(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    sget-object v6, Lcom/android/server/usb/UsbDeviceManager;->PROP_USB_AUTO_LOAD:Ljava/lang/String;
    ...
    .line 609
    :cond_5
    const-string p1, "rndis,marvell_modem,marvell_diag,adb"
    ...
    const-string v7, "setEnabledFunctions mid functions="
    ...
    #calls: Lcom/android/server/usb/UsbDeviceManager;->containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
    invoke-static {v5, v6}, Lcom/android/server/usb/UsbDeviceManager;->access$1200(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v7, "denied add or remove adb !! ,  func is  "
    ...
    const-string v7, " changing  functions = "
    ...
    const-string v6, "mDefaultFunctions.equals(functions)"

    invoke-static {v5, v6}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 644
    iput-boolean v3, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mInUsbSetting:Z
    ...
    .line 649
    iput-boolean v4, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mInUsbSetting:Z
    ...
    #calls: Lcom/android/server/usb/UsbDeviceManager;->addFunction(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    invoke-static {p1, v5}, Lcom/android/server/usb/UsbDeviceManager;->access$1700(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v5}, Lcom/android/server/usb/UsbDeviceManager;->access$1900(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    #calls: Lcom/android/server/usb/UsbDeviceManager;->containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
    invoke-static {p1, v3}, Lcom/android/server/usb/UsbDeviceManager;->access$1200(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v5, " bicr --------------before--------------- functions = "
    ...
    const-string v5, " bicr --------------after---------------- functions = "
    ...
    const-string v6, "Failed to switch to default Fcuntion("
    ...
    const-string v5, "force to switch to default Fcuntion("
    ...
    const-string v4, "Failed to disable USB"
    ...
    #calls: Lcom/android/server/usb/UsbDeviceManager;->processOemUsbOverride(Ljava/lang/String;)Ljava/lang/String;
    invoke-static {v5, p1}, Lcom/android/server/usb/UsbDeviceManager;->access$1000(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v6, "Failed to disable USB  mDefaultFunctions = "
...
.method private updateCurrentAccessory()V
    ...
    const-string v2, " updateCurrentAccessory :  mConfigured="
    ...
    iput-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mSettingUsbCharging:Z
    ...
    invoke-static {v0, v4}, Lcom/android/server/usb/UsbDeviceManager;->access$2102(Lcom/android/server/usb/UsbDeviceManager;[Ljava/lang/String;)[Ljava/lang/String;
...
.method private updateUsbNotification()V
    ...
    invoke-static {v5}, Lcom/android/server/usb/UsbDeviceManager;->access$2500(Lcom/android/server/usb/UsbDeviceManager;)Landroid/app/NotificationManager;
    ...
    #getter for: Lcom/android/server/usb/UsbDeviceManager;->mNotificationManager:Landroid/app/NotificationManager;
    invoke-static {v0}, Lcom/android/server/usb/UsbDeviceManager;->access$2500(Lcom/android/server/usb/UsbDeviceManager;)Landroid/app/NotificationManager;
    ...
    const-string v5, "  updateUsbNotification : mSettingUsbCharging = "

    invoke-virtual {v3, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-boolean v5, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mSettingUsbCharging:Z
    ...
    iget v5, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mPlugType:I
    ...
    const-string v3, " updateUsbNotification : USB_FUNCTION_MTP"
    ...
    const-string v5, " updateUsbNotification : mUsbNotificationId = "
    ...
    const-string v3, "com.android.hmctusbsettings"

    const-string v5, "com.android.hmctusbsettings.UsbSettings"
    ...
    const-string v3, " updateUsbNotification : USB_FUNCTION_PTP"
    ...
    const-string v3, " updateUsbNotification : USB_FUNCTION_MASS_STORAGE"
    ...
    const-string v3, " updateUsbNotification : USB_FUNCTION_ACCESSORY"
    ...
    const-string v3, " updateUsbNotification : USB_FUNCTION_MODEM"
    ...
    const-string v3, "- containsFunction:  USB_FUNCTION_CHARGING_ONLY"
    ...
    const-string v3, "rndis,marvell_modem,marvell_diag,adb"
    ...
    sget-object v3, Lcom/android/server/usb/UsbDeviceManager;->NO_IMEID_FUNCTION:Ljava/lang/String;
    ...
    const-string v3, " updateUsbNotification : else"
...
.method private updateUsbState()V
    ...
    const-string v4, " updateUsbState "
    ...
    const-string v5, " updateUsbState intent "
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    #calls: Lcom/android/server/usb/UsbDeviceManager;->containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
    invoke-static {v4, v7}, Lcom/android/server/usb/UsbDeviceManager;->access$1200(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v8, " handleMessage :  MSG_UPDATE_STATE mConnected="
    ...
    sget-object v7, Lcom/android/server/usb/UsbDeviceManager;->PROP_USB_AUTO_LOAD:Ljava/lang/String;
    ...
    const-string v6, " ddddddddddddddd  handleMessage   mBootCompleted = "
    ...
    .line 863
    iput-boolean v5, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mSettingUsbCharging:Z
    ...
    .line 866
    :cond_7
    iput-boolean v6, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mSettingUsbCharging:Z
    ...
    const-string v8, " handleMessage :  MSG_SET_CURRENT_FUNCTIONS functions="
    ...
    .line 894
    .restart local v2       #makeDefault:Z
    :cond_b
    if-nez v1, :cond_9
    ...
    #calls: Lcom/android/server/usb/UsbDeviceManager;->getCurrentSettings()Lcom/android/server/usb/UsbSettingsManager;
    invoke-static {v4}, Lcom/android/server/usb/UsbDeviceManager;->access$2300(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbSettingsManager;
    ...
    #getter for: Lcom/android/server/usb/UsbDeviceManager;->mDebuggingManager:Lcom/android/server/usb/UsbDebuggingManager;
    invoke-static {v4}, Lcom/android/server/usb/UsbDeviceManager;->access$1600(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbDebuggingManager;
    ...
    .line 944
    :pswitch_6
    iput-boolean v6, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mAdbNotificationShown:Z
...
.method public updateState(Ljava/lang/String;)V
    ...
    const-string v6, "  updateState  state = "
    ...
    .line 537
    iget-boolean v4, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mInUsbSetting:Z
    ...
    const-string v6, " dddddddddd delay = "
