...
.method protected chooseUpstreamType(Z)V
    ...
    invoke-static {v12}, Lcom/android/server/connectivity/Tethering;->access$4700(Lcom/android/server/connectivity/Tethering;)Ljava/util/Collection;
    ...
    invoke-static {v12}, Lcom/android/server/connectivity/Tethering;->access$3100(Lcom/android/server/connectivity/Tethering;)Landroid/net/IConnectivityManager;
    ...
    invoke-static {v14}, Lcom/android/server/connectivity/Tethering;->access$4800(Lcom/android/server/connectivity/Tethering;)I
    ...
    :cond_4
    :goto_3
    new-instance v10, Lcom/android/server/connectivity/Tethering$UpstreamInterfaces;
    ...
    invoke-direct {v10, v12, v8}, Lcom/android/server/connectivity/Tethering$UpstreamInterfaces;-><init>(Lcom/android/server/connectivity/Tethering;Landroid/net/LinkProperties;)V

    .line 1569
    .local v10, uifs:Lcom/android/server/connectivity/Tethering$UpstreamInterfaces;
    invoke-virtual {v10, v5}, Lcom/android/server/connectivity/Tethering$UpstreamInterfaces;->setUpstreamV4IfaceName(Ljava/lang/String;)V

    .line 1570
    move-object/from16 v0, p0

    invoke-virtual {v0, v10}, Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherMasterUtilState;->notifyTetheredOfNewUpstreamIface(Lcom/android/server/connectivity/Tethering$UpstreamInterfaces;)V
    ...
    .end local v10           #uifs:Lcom/android/server/connectivity/Tethering$UpstreamInterfaces;
    :cond_5
    const/4 v12, 0x5
    ...
    invoke-interface {v12, v11}, Landroid/net/IConnectivityManager;->getLinkProperties(I)Landroid/net/LinkProperties;
    :try_end_4
    ...
    const-string v14, "Finding IPv4 upstream interface on: "
    ...
    .line 1524
    invoke-virtual {v8}, Landroid/net/LinkProperties;->getAllRoutes()Ljava/util/Collection;
    ...
    .line 1526
    .local v7, ipv4Default:Landroid/net/RouteInfo;
    if-eqz v7, :cond_7
    ...
    const-string v14, "Found interface "
    ...
    invoke-static {v12}, Lcom/android/server/connectivity/Tethering;->access$2200(Lcom/android/server/connectivity/Tethering;)Landroid/os/INetworkManagementService;

    move-result-object v12

    invoke-interface {v12, v1}, Landroid/os/INetworkManagementService;->setDnsForwarders([Ljava/lang/String;)V
    :try_end_5
    ...
    invoke-static {v13}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$3900(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Lcom/android/internal/util/State;

    move-result-object v13

    #calls: Lcom/android/server/connectivity/Tethering$TetherMasterSM;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v12, v13}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$4900(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Lcom/android/internal/util/IState;)V
    ...
    const-string v13, "No IPv4 upstream interface, giving up."
    ...
    .line 1518
    .end local v7           #ipv4Default:Landroid/net/RouteInfo;
    :catch_1
    move-exception v12
...
.method protected notifyTetheredOfNewUpstreamIface(Lcom/android/server/connectivity/Tethering$UpstreamInterfaces;)V
    ...
    invoke-static {v2, p1}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$5002(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Lcom/android/server/connectivity/Tethering$UpstreamInterfaces;)Lcom/android/server/connectivity/Tethering$UpstreamInterfaces;
